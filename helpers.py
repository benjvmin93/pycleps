class SlurmOptions:
    ...
    def __init__(self, job_name: str = "", time: str = "", partition: str = "", nodes: int = 1, ntasks_per_node: int = 1,
    ...
    def to_slurm_directives(self) -> str:
        ...
        options_dict = {
            ...
            "mem": self.memory,
            "output": f"{self.output}/{output_suff}" if self.output != "" else f"{output_suff}",
            "error": self.error,
        }
